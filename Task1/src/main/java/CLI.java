...
public class CLI {
    final public static Map<Integer, String> constants = new HashMap<>();
            ...
            for (int i = 0; i < constPoolCount - 1; ++i) {
                ...
                switch (tag) {
                    ...
                    case (12):
                        ...
                        break;
                    case (1):
                        System.out.println(new String(is.readNBytes(is.readUnsignedShort()), StandardCharsets.UTF_8));
                        break;
                }
            }
